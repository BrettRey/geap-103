...
Course materials for GEAP 103 at [Humber College](https://humber.ca) (Toronto). The 14-unit [CEFR B1](https://www.coe.int/en/web/common-european-framework-reference-languages/level-descriptions) [EAP](https://en.wikipedia.org/wiki/English_for_academic_purposes) curriculum teaches English through digital tool use and AI interaction. Fall 2026 sections use separate 14- and 12-meeting schedules.

**Thesis:** "English is the control layer." Students learn to say what they want clearly enough for AI to help them do it. AI can handle much of the technical complexity when it is available. The student's job is to articulate, evaluate, verify, and revise.
...
This course launches September 2026. Materials are in active development. Weekly materials packages are complete for Weeks 1–14, with additional 12- and 13-meeting delivery materials.

## License

[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) — use, adapt, and share with attribution.
