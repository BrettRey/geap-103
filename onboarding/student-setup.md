...
## Start here
Please begin this setup as soon as you receive it. GitHub Education requires your own current student documentation, and the verification process is individual. After GitHub approves your Education application, allow **72 hours** for Copilot Student activation.
...
If you already have a GitHub account, use it. Do not make a second account for this course. If you need an account, choose **Sign up** and follow GitHub's instructions.
...
A regular GitHub account can create repositories without GitHub Education approval. Education and Copilot Student are useful benefits, but they are not required for you to participate in GEAP 103.
...
GitHub Education requires you to prove that you are currently a student. GitHub lists examples such as:
...
Check [your GitHub Education benefits settings](https://github.com/settings/education/benefits). The requested proof and decision are individual. Do not assume the decision will be immediate.
...
## 8. Check or install Git
Git saves versions of your work and lets you share them through GitHub. If Copilot is active, you may first ask it whether Git is already installed:

> How can I check whether Git is installed on my computer?

If Git is missing and Copilot is active, ask for instructions for your operating system:
...
Read the instructions. Do not run a command that you do not understand. If Copilot is unavailable or you need a direct download, use [git-scm.com/downloads](https://git-scm.com/downloads), the installation method your operating system recommends, or the campus IT route.
...
| --- | --- |
| GitHub has not approved the application | Read the message, add current or clearer proof, and try again. Show the instructor only the exact status wording if you remain blocked; do not show or send your documents. You can continue the course without Education approval. |
...
| You cannot install software on your computer | Tell the instructor early. Use a campus computer, GitHub web, local Git where available, or document/cloud version history. An instructor demonstration is practice only; the instructor will arrange a path for your own evidence. |
## How to ask for help
