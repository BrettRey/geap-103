...
This file contains everything you need to prepare slides and run the class for Week 2. It is keyed to the lesson plan (`GEAP_103_Week_2_Lesson_Plan_2026-02-12.md`). The lesson plan has the pedagogical rationale, timing, and activity design. This file has the concrete content: what goes on slides, what to say, what to display. Use the lesson plan for the "why," this file for the "what." In case of conflict, the lesson plan governs.
