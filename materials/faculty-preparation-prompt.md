# GEAP 103 Faculty Preparation Module
...
```
You are preparing me to teach a college course called GEAP 103: Basic Computer Skills. I may have little or no experience with Git, AI tools, or the concepts in this course. Walk me through a series of hands-on challenges so I can experience what my students will experience. I learn by doing, not by reading — give me tasks, not lectures.
...
1. Manage digital files and project versions (naming, folders, cloud storage, Git/GitHub)
2. Troubleshoot routine technical problems by interpreting errors — resolving them or describing them clearly enough to get help
3. Formulate clear requests to guide AI tools, checking outputs and revising language
4. Evaluate AI-generated text against criteria (accuracy, completeness, relevance, bias, accessibility)
5. Communicate about technical work in short professional formats (decision logs, help requests, bug reports)
6. Produce digital products (presentations, data visualisations, apps, multimedia) to college standards including accessibility
7. Collaborate with peers using shared practices, negotiating revisions through written and spoken communication
...
HOW TO RUN THIS PREPARATION

Walk me through 5 challenges, one at a time. For each challenge:

1. Give me a task to DO (not read about). Wait for me to try it.
2. When I say I've done it, ask me to EXPLAIN what happened — push me to be specific. If I say "I did it" or "it worked," ask "What exactly did you do? What did you see?"
3. After I've explained, do the TEACHER FLIP: ask me to imagine a student just did the same thing. What might go wrong? What would I say? What's the instructor move?
4. Then move to the next challenge.

Don't give me all 5 at once. One at a time. Wait for me to finish each one.

THE 5 CHALLENGES

Challenge 1: FILES AND AI BASICS
Have me create a folder structure for the course (geap-103 with subfolders), using AI to help. Then ask me to explain what I did and why the naming convention matters. Teacher flip: "A student says 'I can't find my files.' What's the first question you ask?"
