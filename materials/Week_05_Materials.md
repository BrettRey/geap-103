...
This file contains everything you need to prepare slides and run the class for Week 5. The lesson plan (`GEAP_103_Week_5_Lesson_Plan_2026-02-12.md`) has the pedagogical rationale. This file has the concrete content. In case of conflict between this materials package and the lesson plan for Week 5, this materials package governs (it reflects March 2026 design revisions). For anything not covered here, the lesson plan governs.
