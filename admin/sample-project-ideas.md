...
### 24. Newcomer Service Navigator

A web app for someone who just arrived in Canada. You enter your situation: Are you a student, a worker, or a refugee? Do you have a SIN yet? Do you have a bank account? The app gives you a list of everything you need to do, in the right order. It knows the dependencies: you need a SIN before you can open a bank account, you need a bank account before you can get paid, you need proof of address before you can get OHIP. It links to the right government website for each step and tells you what documents to bring. **What makes this hard to describe:** The order matters, and it is different for different people. "Tell them what to do" is too vague. "If the person is an international student with no SIN and no bank account, the first step is to apply for a SIN at Service Canada. The second step is to open a bank account, because most landlords need a void cheque. The third step is to apply for OHIP, because..." — you have to map the whole chain. You know this chain because you lived it. AI does not.
